...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgSData(oldp+0,(vlSelf->sigdelay__DOT__addr1),9);
        bufp->chgSData(oldp+1,(vlSelf->sigdelay__DOT__wr_addr),9);
        bufp->chgSData(oldp+2,(vlSelf->sigdelay__DOT__rd_addr),9);
        bufp->chgSData(oldp+3,(vlSelf->sigdelay__DOT__din),9);
        bufp->chgSData(oldp+4,(vlSelf->sigdelay__DOT__dout),9);
    }
    bufp->chgBit(oldp+5,(vlSelf->clk));
    bufp->chgBit(oldp+6,(vlSelf->rst));
    bufp->chgBit(oldp+7,(vlSelf->wr));
    bufp->chgBit(oldp+8,(vlSelf->rd));
    bufp->chgSData(oldp+9,(vlSelf->mic_signal),9);
    bufp->chgSData(oldp+10,(vlSelf->offset),9);
    bufp->chgSData(oldp+11,(vlSelf->incr),9);
    bufp->chgSData(oldp+12,(vlSelf->delayed_signal),9);
}

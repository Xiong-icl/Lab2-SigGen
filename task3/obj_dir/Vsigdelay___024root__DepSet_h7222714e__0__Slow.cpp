...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->mic_signal = VL_RAND_RESET_I(9);
    vlSelf->offset = VL_RAND_RESET_I(9);
    vlSelf->incr = VL_RAND_RESET_I(9);
    vlSelf->delayed_signal = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__addr1 = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__wr_addr = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__rd_addr = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__din = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__dout = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__en = VL_RAND_RESET_I(1);
    for (int __Vi0=0; __Vi0<512; ++__Vi0) {
        vlSelf->sigdelay__DOT__ramdualport__DOT__ram_array[__Vi0] = VL_RAND_RESET_I(9);
    }

...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    __Vdly__sinegen__DOT__addr1 = ((IData)(vlSelf->rst)
                                    ? 0U : (0xffU & 
                                            ((IData)(vlSelf->sinegen__DOT__addr1) 
                                             + (IData)(vlSelf->en))));
    vlSelf->dout1 = vlSelf->sinegen__DOT__rom__DOT__rom_array
        [vlSelf->sinegen__DOT__addr1];
    vlSelf->dout2 = vlSelf->sinegen__DOT__rom__DOT__rom_array
